...
class Estruturas4Controller extends Controller
{
  ...
  public function salvar($request, $id, $tipo_operacao)
  {
    ...
    public function create()
    {
        ...
        return view($this->rota . '.registrar', ['nivel1'=>$view1, 'nivel2'=>$view2, 'nivel3'=>$view3]);
...
*/
    ...
    private function exibir ($request, $id, $preview)
    {
       ...
       /*Busca NIVEL2*/
        ...
        return view($this->rota . '.edit', ['dados' =>$dados, 'preview' => $preview, 'nivel1' =>$view1, 'nivel2' =>$view2, 'nivel3' =>$view3]);
