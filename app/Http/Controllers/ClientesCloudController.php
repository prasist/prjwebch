    ...
    public function index()
    {
       ...
       */
        ...
        if ($cadastrou)
        {
            ...
            return view('cliente.index',compact('clientes_cloud'));
        }
        else
        {
...
*/
    public function store(\Illuminate\Http\Request  $request)
    {
        ...
        $clientes_cloud->save();
        //clientescloud::create($request->all());
    ...
    public function show(Request $request, $id)
    {
            ...
            return view('cliente.show',compact('clientes_cloud'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('cliente.edit',compact('clientes_cloud'));
    }
    ...
    {
        $msg = Ajaxis::MtDeleting('Aviso!!','Confirma exclusão ?','/cliente/'. $id . '/delete/');
