...
(function ($) {
    ...
    */
    ...
    /*Modificado - Fabiano - 27-05-2016*/
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-primary btn-xs"><i class="fa fa-check"></i></button>'+
    '<button type="button" class="btn btn-default btn-xs editable-cancel"><i class="fa fa-close"></i></button>';
