                      ...
                      <div class="tab-pane active" id="tab_1">
                          ...
                          <div class="row">
                                  ...
                                  <div class="col-xs-3">
                                        ...
                                        <input id="mes"  placeholder="(Opcional)" name = "mes" type="text" class="form-control" value="">
                                  </div>

                                  <div class="col-xs-3">
                                        <label for="ano" class="control-label">Ano</label>
                                        <input id="ano"  placeholder="(Opcional)" name = "ano" type="text" class="form-control" value="">
                                  </div>
