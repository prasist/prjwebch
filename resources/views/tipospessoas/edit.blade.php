                          ...
                          <input  name="membro" type="hidden"  value="false" />
                           ...
                           <div class="row">
                                    <div class="col-xs-2">
                                          ...
                                          <input  name="fisica" type="checkbox" class="acessar" value="true" {{ ($dados->fisica==true ? 'checked' : '') }} />
                                    </div>

                                    <div class="col-xs-2">
                                          <label for="juridica" class="control-label">Pessoa Jurídica</label>
                                          <input  name="juridica" type="checkbox" class="acessar" value="true" {{ ($dados->juridica==true ? 'checked' : '') }} />
                                    </div>

                                    <div class="col-xs-2">
                                          <label for="membro" class="control-label">Membro</label>
                                          <input  name="membro" type="checkbox" class="acessar" value="true" {{ ($dados->membro==true ? 'checked' : '') }} />
                                    </div>
                            </div>
                            ...
                            <div class="row{{ $errors->has('name') ? ' has-error' : '' }}">
                                    <div class="col-xs-10">
                                          ...
                                          <input id="name" maxlength="60"  name = "name" type="text" class="form-control" value="{{ $dados->nome }}">
