...
<div class = 'row'>
    ...
    <div class="col-md-12">
        ...
        <form method = 'POST'  class="form-horizontal" action = {{ url('/cliente/gravar')}}>
                                  ...
                                  <div class="tab-pane fade active in" id="home">
                                        ...
                                        <div class="row{{ $errors->has('razaosocial') ? ' has-error' : '' }}">
                                                <div class="col-xs-10">
                                                      ...
                                                      <input id="razaosocial" maxlength="150"  name = "razaosocial" type="text" class="form-control" value="{{ old('razaosocial') }}">
                                ...
                                <div class="tab-pane fade" id="compl">
                                    ...
                                    <div class="row">
                                            <div class="col-xs-9">
                                                    ...
                                                    <input type="file" id="caminhologo" maxlength="255" name = "caminhologo" class="form-control" value="{{old('caminhologo')}}">
                                            </div>
                                    </div>
