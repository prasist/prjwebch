...
<select id="{{$id_combo}}" name="{{$id_combo}}" {{$complemento}}  data-live-search="true" data-none-selected-text="Nenhum item selecionado"  placeholder="(Selecionar)" class="form-control selectpicker" data-actions-box="true" style="width: 100%;">
<option  value=""></option>
